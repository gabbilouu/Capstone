...
public class TaskListFragment extends Fragment implements View.OnClickListener{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        if (homeButton != null) {
            ...
            Log.e("TaskListFragment", "HomeButton not found!");
        }

        if (listButton != null) {
            listButton.setOnClickListener(this);
        } else {
            Log.e("TaskListFragment", "ListButton not found!");
        }

        if (profileButton != null) {
            profileButton.setOnClickListener(this);
        } else {
            Log.e("TaskListFragment", "ProfileButton not found!");
        }
    }
    ...
    public void onClick(View v) {
        if (navC != null) {
            if (v.getId() == R.id.HomeButton) {
                navC.navigate(R.id.action_taskListFragment_to_mainPageFragment);
            } else if (v.getId() == R.id.ListButton) {
                navC.navigate(R.id.action_taskListFragment_to_eventListFragment);
